...
class WebauthnEnrollWidget extends StatelessWidget {
  final WebauthnEnrollWidgetModel config;
  final String formId;
  final LoginContext loginContext;

  const WebauthnEnrollWidget({
    super.key,
  ...
  Future<void> onPressed() async {
    try {
      final result = await PasskeyService.enroll(config.enrollOptions);
